...
silent only
cd ~/Documents/git/Vim/Notes
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 fastCmd.md
badd +0 ~/Documents/test/case.sh
args fastCmd.md
edit ~/Documents/test/case.sh
...
exe 'vert 2resize ' . ((&columns * 37 + 37) / 74)
exe '3resize ' . ((&lines * 16 + 17) / 35)
exe 'vert 3resize ' . ((&columns * 36 + 37) / 74)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
